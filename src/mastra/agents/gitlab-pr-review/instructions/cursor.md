...
- `text`：中文评审内容，每条 `text` 末尾需要附带**问题代码与优化代码对比**，格式如下：

  **❌ 有问题的代码：**
  <pre><code lang='javascript'>
  { diff变更后的原始代码中，有问题的代码或 HTML 片段 }
  </code></pre>

  **✅ 优化后的代码：**
  <pre><code lang='javascript'>
  { 你优化/修改后的代码或 HTML 片段，不要直接展示diff变更中的新增代码 }
  </code></pre>要求：

  - **优化后的代码**必须是你的新版本，在原本代码上做出了优化
  - 不要输出任何形式的正面、肯定或总结性评论
